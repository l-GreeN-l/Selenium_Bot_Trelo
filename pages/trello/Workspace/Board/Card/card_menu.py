...
class CardPageLocators():
    ...
    TA_DESCRIPTION_BTN_SAVE = (
        By.XPATH, '//*[contains(@class, "description-edit")]/descendant::*[contains(@value, "Save")]')
    TA_DESCRIPTION = (By.XPATH, '//*[contains(@class, "current markeddown")]/*')
    TA_COMMENT = (By.XPATH,
                  '//*[contains(@class, "comment-box")]/*[contains(@class,'
                  ' "comment-box-input")][contains(@placeholder, "Write a comment")]')
    ...
    BTN_ADD_MEMBER = (By.XPATH, '//*[contains(@class, "card-members")]/*[contains(@class, "icon-member")]')
    TF_MEMBER = (By.XPATH, '//input[contains(@class, "search-mem")]')
    MEMBER = (By.XPATH, '//*[@class="name js-select-member"]')

    BTN_ADD_LABEL = (By.XPATH, '//*[contains(@class, "edit-labels")]')
